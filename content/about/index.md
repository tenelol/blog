...
- `Yuki Matsuda`
- `INIAD / Tokyo`
- 学生バックエンドエンジニアとして、Go、Nix、個人開発、静的サイト運用まわりを継続的に試しています。
...
- バックエンドや開発基盤に近いインターン
- 小さく作って継続的に改善する開発
- 実装と文章の両方でアウトプットできる環境

## Writing Policy

- 自分で書いた技術的な記事は `Zenn`
- AI を使った試行や個人的な公開メモはこのサイト
- 実力を小さく見せるのではなく、書けることは根拠つきで素直に書く

## This Site

このサイトは `Works` と `Writing` を役割で分けています。`Works` では GitHub 上の制作物や実装物を、`Writing` ではこのサイト内の記事と Zenn の技術記事をまとめます。技術記事は `Zenn`、AI を使った試行や個人的な公開メモはこのサイトに寄せる方針です。
